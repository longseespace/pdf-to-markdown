  ...
  render() {
    ...
    const aboutPopover = (
      <Popover
        ...
        title={`About PDF to Markdown Converter - ${process.env.version}`}
      >
        <p>
          <i>PDF to Markdown Converter</i> will convert your uploaded PDF to
          Markdown format.
        </p>
      </Popover>
    );
    ...
    return (
      <Navbar inverse>
        <Navbar.Header>
          <Navbar.Brand>
            <Dropdown id="logo-dropdown">
              ...
              <Dropdown.Menu>
                <MenuItem divider />
                <MenuItem href="https://pdfpals.com">
          ...
          {showTabs && (
            <Nav bsStyle="tabs" activeKey={mainView} pullRight>
              <NavItem
                eventKey={View.DEBUG}
                activeKey={mainView}
                onSelect={switchMainViewFunction}
              >
                Debug View
              </NavItem>
              <NavItem
                eventKey={View.RESULT}
                activeKey={mainView}
                onSelect={switchMainViewFunction}
              >
                Result View
        ...
        <Navbar.Collapse>
          <Navbar.Text pullRight={true}>{title}</Navbar.Text>
        </Navbar.Collapse>
      </Navbar>
    );
  }
